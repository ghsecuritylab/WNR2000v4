...
extern unsigned long long tm_limit;
extern int need_back;
extern unsigned long long counter_rx,counter_tx;
extern int br_tm_dir;
extern need_drop ;
extern int msg_recive;
...
#define BR_PROC_IPTV_PORT       "br_iptv_port"
#define BR_PROC_IPTV_ENABLE     "br_iptv_enable"
#define IPTV_PORT_GROUP_MAX     10
struct __iptv_port_mgroup{
	char port_name[16];
	uint32_t group_ip;
	int group_time;
};
extern int iptv_port_enable;
extern struct __iptv_port_mgroup iptv_port_mgroup[IPTV_PORT_GROUP_MAX];
extern struct timer_list iptv_port_timer;
extern void iptv_port_timer_thread(void);
extern void iptv_port_print_mgroup(void);
#endif
