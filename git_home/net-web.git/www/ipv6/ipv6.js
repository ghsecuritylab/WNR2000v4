	...
	/* Use This Interface ID */
        if( cf.enable_interface.checked == true )
        {
	        ...
	        for( i=0; i<cf.IP_interface.length; i++ )
        	{
                	...
                	{
				alert("$ipv6_invalid_interface_id");//to fix bug30989
                        	return false;
                	}
                	...
                	{
				//to fix bug30515:"interface ID" can be set to "x:x:x:0",and it will make ipv6 address of lan to be a network segment.
...
/*to fix bug30507:the detected mode should be translated*/
