...
function check_router_add(cf,flag)
{
	...
	//31735 cf.route_name.value = remove_space(cf.route_name.value); 
	...
	//fixed bug30258:A route like nework id (eg 10.0.0.0 mask 255.255.255.255) should not be added to route table
	if(cf.SRouteSubnetMask.value=="255.255.255.255" && cf.SRouteDestAddr4.value=="0")
	{
		alert("$invalid_ip");
		return false;
	}
