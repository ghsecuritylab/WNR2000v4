...
function load_top_value()
{
	...
	//bug 31947, if device is running on AP Mode, GUI top banner show "Operating Mode: Access Point"
	if( enable_ap_flag == "1" )
		document.getElementById("ap-mode").style.display="";
	else
		document.getElementById("ap-mode").style.display="none";
