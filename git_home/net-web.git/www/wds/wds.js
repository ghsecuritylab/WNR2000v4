...
//fix bug 32010:in ap mode,in "Wireless Repeating Function" that is "Repeater IP Address"must be gray out if WDS is enabled
	if(cf.wds_enable.checked == true && enable_ap_flag ==1)
		setDisabled (true, cf.sysLANIPAddr1,cf.sysLANIPAddr2,cf.sysLANIPAddr3,cf.sysLANIPAddr4);
	else
		setDisabled (dflag, cf.sysLANIPAddr1,cf.sysLANIPAddr2,cf.sysLANIPAddr3,cf.sysLANIPAddr4);
	
	setDisabled ( dflag, cf.wds_mode[0], cf.ptp_sta, cf.pmp_sta, cf.ptp_mac,cf.wds_mode[1], cf.pmp_sta, cf.pmp_mac1,cf.pmp_mac2,cf.pmp_mac3,cf.pmp_mac4);
...
function click_endis_wds_a()
{
	...
	if(cf.wds_enable.checked == true && enable_ap_flag ==1)
			setDisabled (true, cf.sysLANIPAddr1_an,cf.sysLANIPAddr2_an,cf.sysLANIPAddr3_an,cf.sysLANIPAddr4_an);
	else
			setDisabled (dflag_a, cf.sysLANIPAddr1_an,cf.sysLANIPAddr2_an,cf.sysLANIPAddr3_an,cf.sysLANIPAddr4_an);
	
	setDisabled ( dflag_a, cf.wds_mode_an[0], cf.ptp_sta_an, cf.pmp_sta_an, cf.ptp_mac_1_an,cf.wds_mode_an[1], cf.pmp_sta_an, cf.pmp_mac1_1_an,cf.pmp_mac2_1_an,cf.pmp_mac3_1_an,cf.pmp_mac4_1_an);//cf.sysLANIPAddr1_an,cf.sysLANIPAddr2_an,cf.sysLANIPAddr3_an,cf.sysLANIPAddr4_an,
...
function click_repeater_basic()
{
	...
	if(cf.wds_enable.checked == true && enable_ap_flag ==1)
		...
		setDisabled (aflag, cf.sysLANIPAddr1,cf.sysLANIPAddr2,cf.sysLANIPAddr3,cf.sysLANIPAddr4);

	setDisabled ( aflag, cf.ptp_sta, cf.pmp_sta, cf.ptp_mac);//cf.sysLANIPAddr1,cf.sysLANIPAddr2,cf.sysLANIPAddr3,cf.sysLANIPAddr4,  
...
function click_repeater_basic_a()
{
	...
	if(cf.wds_enable.checked == true && enable_ap_flag ==1)
		...
		setDisabled (aflag_a, cf.sysLANIPAddr1_an,cf.sysLANIPAddr2_an,cf.sysLANIPAddr3_an,cf.sysLANIPAddr4_an);

        setDisabled ( aflag_a, cf.ptp_sta_an, cf.pmp_sta_an, cf.ptp_mac_1_an);//cf.sysLANIPAddr1_an,cf.sysLANIPAddr2_an,cf.sysLANIPAddr3_an,cf.sysLANIPAddr4_an,
