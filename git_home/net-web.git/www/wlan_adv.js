...
function checkadv(form)
{
	...
	{	
        ...
        if(!(form.rts.value > 0 && form.rts.value <= 2347) || !(form.rts_an.value > 0 && form.rts_an.value <= 2347) || !_isNumeric(form.rts.value) || !_isNumeric(form.rts_an.value))
        {
                alert("$rts_range");
                return false;
        }
	...
	if(!(form.frag.value > 255 && form.frag.value < 2347) || !(form.frag_an.value > 255 && form.frag_an.value < 2347) || !_isNumeric(form.frag.value) || !_isNumeric(form.frag_an.value))
	{
		alert("$fragmentation_range");
		return false;
	}
	...
	if(form.wsc_config.checked == true)
	{
		...
		form.endis_wsc_config_a.value="5"; // 35251: Add this line
	}
	else
	{
		form.endis_wsc_config.value="1";
		form.endis_wsc_config_a.value="1"; //35251: add this line
	}
/* bug 35251	
