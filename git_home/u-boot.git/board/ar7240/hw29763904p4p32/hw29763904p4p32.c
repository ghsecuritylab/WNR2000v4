...
//	ar7240_reg_wr(ATH_GPIO_OUT_FUNCTION1, (rddata & 0xffffffff)); /* 07, 06, 05, 04 */
//	rddata = ar7240_reg_rd(ATH_GPIO_OUT_FUNCTION2);
//	ar7240_reg_wr(ATH_GPIO_OUT_FUNCTION2, (rddata & 0xffffffff)); /* 11, 10, 09, 08 */
//	rddata = ar7240_reg_rd(ATH_GPIO_OUT_FUNCTION3);
	ar7240_reg_wr(ATH_GPIO_OUT_FUNCTION3, 0x2b2a2900);            /* 15, 14, 13, 12 */
//	rddata = ar7240_reg_rd(ATH_GPIO_OUT_FUNCTION4);
	ar7240_reg_wr(ATH_GPIO_OUT_FUNCTION4, 0x00002d2c);            /* 19, 18, 17, 16 */
	rddata = ar7240_reg_rd(ATH_GPIO_OUT_FUNCTION5);
	ar7240_reg_wr(ATH_GPIO_OUT_FUNCTION5, (rddata & 0xff000000)); /* 23, 22, 21, 20 */

	/* let gpio pin of power, status, WLAN, LAN & WAN leds be output enabled. */
	ar7240_reg_rmw_clear(ATH_GPIO_OE,
	                     (1 << POWER_LED_GPIO) | (1 << STATUS_LED_GPIO) |
	                     (1 << WLAN_LED_GPIO) | (1 << WPS_LED_GPIO) |
	                     (1 << LAN1_GLED_GPIO) | (1 << LAN2_GLED_GPIO) |
	                     (1 << LAN3_GLED_GPIO) | (1 << LAN4_GLED_GPIO) |
	                     (1 << LAN1_ALED_GPIO) | (1 << LAN2_ALED_GPIO) |
	                     (1 << LAN3_ALED_GPIO) | (1 << LAN4_ALED_GPIO) |
	                     (1 << WAN_GLED_GPIO) | (1 << WAN_ALED_GPIO) );
	/* off all leds */
	ar7240_reg_rmw_set(ATH_GPIO_OUT,
	                     (1 << POWER_LED_GPIO) | (1 << STATUS_LED_GPIO) |
	                     (1 << WLAN_LED_GPIO) | (1 << WPS_LED_GPIO) |
	                     (1 << LAN1_ALED_GPIO) | (1 << LAN2_ALED_GPIO) |
	                     (1 << LAN3_ALED_GPIO) | (1 << LAN4_ALED_GPIO) |
...
int	checkboard(void)
{
	printf("DNI HW ID: 29763904 flash 4MB RAM 32MB U-boot dni29 V0.5\n");
	return 0;
}
