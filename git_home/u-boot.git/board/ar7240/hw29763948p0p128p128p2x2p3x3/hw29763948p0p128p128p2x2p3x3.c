...
int	checkboard(args)
{
	board_str("U-boot dni29 V0.5 for DNI HW ID: 29763948 flash 128MB RAM 128MB 1st Radio 2x2 2nd Radio 3x3\n");
	return 0;
}
...
int board_model_id_match_open_source_id()
{
	char *s;
	...
	return strcmp(s, (char*)OPEN_SOURCE_ROUTER_ID) == 0;

empty_out:
	return 0;
}

int board_image_reserved_length()
{
	return board_model_id_match_open_source_id() * CFG_RESERVED_LEN;
}
#endif
#endif	/* BOARD_ID */
