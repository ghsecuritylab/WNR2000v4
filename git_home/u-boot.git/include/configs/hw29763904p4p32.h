...
#define STATUS_LED_GPIO    1   /* status led, amber (Output Pin/Active LOW) */
#define RESET_BUTTON_GPIO  4   /* reset button (Input Pin/Active LOW) */
#define WLAN_LED_GPIO     12   /* WLAN led, blue (Output Pin/Active LOW) */
#define WPS_LED_GPIO       2   /* WPS led, green (Output Pin/Active LOW) */
#define LAN1_GLED_GPIO    13   /* LAN1 led, green (Output Pin/Active LOW) */
#define LAN2_GLED_GPIO    14   /* LAN2 led, green (Output Pin/Active LOW) */
#define LAN3_GLED_GPIO    15   /* LAN3 led, green (Output Pin/Active LOW) */
#define LAN4_GLED_GPIO    16   /* LAN4 led, green (Output Pin/Active LOW) */
#define WAN_GLED_GPIO     17   /* WAN led, green (Output Pin/Active LOW) */
#define LAN1_ALED_GPIO    18   /* LAN1 led, amber (Output Pin/Active LOW) */
#define LAN2_ALED_GPIO    19   /* LAN2 led, amber (Output Pin/Active LOW) */
#define LAN3_ALED_GPIO    20   /* LAN3 led, amber (Output Pin/Active LOW) */
#define LAN4_ALED_GPIO    21   /* LAN4 led, amber (Output Pin/Active LOW) */
#define WAN_ALED_GPIO     22   /* WAN led, amber (Output Pin/Active LOW) */
