/*
 * wnr2000v4.c - partially based on OpenWrt's add_header.c
 *
...
static void usage(const char *mess)
{
	...
	fprintf(stderr, "Usage: wnr2000v4 input_file output_file\n");
	fprintf(stderr, "\n");
	exit(1);
}
...
int main(int argc, char **argv)
{
	...
	init_crc32();
        ...
        header.magic = htonl(0x32303034); /* 2000v4 in ascii */
	header.crc = 0;
